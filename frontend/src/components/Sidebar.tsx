...
export function Sidebar({ isOpen, onClose, currentPath, onNavigate }: Props) {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <aside
        className={`fixed left-0 top-0 z-50 flex h-full w-64 flex-col bg-white transition-transform duration-300 ${
